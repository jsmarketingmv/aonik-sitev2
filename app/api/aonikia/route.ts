...
Responda em português brasileiro, de forma amigável e calorosa. Máximo 3 parágrafos.
Se não souber algo específico, diga que vai confirmar com a equipe AONIK.
`.trim(),
...
TARIFAS: Sob consulta, variáveis por tipo de cabine (Doble Interior / Exterior / Deluxe / Suite) e temporada. Incluem todas as refeições a bordo, excursões e transfer aeroporto-navio.
...
- Se perguntar sobre datas: indicar o calendário acima e reforçar: "As vagas se esgotam rápido, especialmente na temporada alta. Vale confirmar com a equipe o quanto antes!"
...
Responda em português brasileiro, de forma amigável, sensorial e calorosa. Máximo 3 parágrafos.
Se não souber algo específico, diga que vai confirmar com a equipe AONIK.
`.trim(),
...
- Dia 1: Chegada a Nazaré (a vila dos pescadores, ondas gigantes)
...
- Se expressar interesse: "Chegar a Fátima a pé depois de 4 dias caminhando tem um peso diferente. Seja qual for a sua fé, é uma experiência que transforma. Nossa equipe organiza tudo para você! [Falar no WhatsApp do time AONIK →]"
...
- 8 cabines históricas: Starkenburger, Franz Senn, Neue Regensburger, Dresdner, Nürnberger, Bremer e Innsbrucker Hütte
...
DESTAQUES:
- Ninho da Águia (Kehlsteinhaus, 1.800 m): mirante histórico dos anos 1930, vistas inesquecíveis
- Königssee: o lago alpino mais puro da Alemanha, cercado de picos rochosos
...
LOCALIZAÇÃO: Dentro do Parque Nacional Torres del Paine (único complexo completo dentro do parque)
...
TARIFAS (por quarto, em USD — incluem margem AONIK):
ALL INCLUSIVE:
- Baixa (10/Set–10/Out 2026 · 1–2/Mai 2027): Classic duplo US$1.394 · Standard duplo US$1.463 · Superior duplo US$1.611
- Média (11/Out–31/Out 2026 · Abr/2027): Classic duplo US$1.806 · Standard duplo US$1.886 · Superior duplo US$2.091
- Alta (1/Nov–22/Dez 2026 · Jan–Mar 2027): Classic duplo US$2.331 · Standard duplo US$2.446 · Superior duplo US$2.686
- Final de Ano (23/Dez–6/Jan · mínimo 2 noites): Classic duplo US$2.891 · Superior duplo US$3.531
FULL BOARD e B&B: a partir de US$309/noite (Classic single B&B, baixa temporada)
Criança: consulte. Quarto adicional: consulte.
...
- Se expressar interesse: "Acordar dentro do Parque Nacional Torres del Paine, com os Cornos visíveis pela janela do quarto — é simplesmente incrível. Nossa equipe reserva tudo para você. [Falar no WhatsApp do time AONIK →]"
...
NÍVEL: Leve (perfeito para quem quer imersão enogastronômica sem esforço físico intenso)
...
ROTEIRO (6 dias · Alijó/Pinhão):
- Dia 1: Chegada a Alijó
- Dia 2: Alijó → Enoteca Avessada → Favaios (6,1 km · +157m · prova + Aldeia Vinhateira)
- Dia 3: Lamego → Samodães → estrada N222 → Pinhão (8,2 km · +219m · Quinta da Pacheca + prova)
...
INCLUI: todas as hospedagens, café da manhã todos os dias, lunch box nos dias de caminhada, todas as 5 experiências enogastronômicas indicadas, transfers internos, transfer de bagagem.
...
DISTÂNCIA: 121 km Caminho Português + 12 km no Douro (total 133 km · 8 dias de caminhada)
...
- Dia 8: Dia livre em Santiago (catedral, abraço ao Apóstolo, descanso)

VALE DO DOURO (4 dias):
- Dia 9: Transfer Santiago → Porto → Pinhão (tarde livre)
- Dia 10: Casal de Loivos → Pinhão (5,4 km · vinhas, Quinta do Bomfim + barco rabelo)
- Dia 11: Provesende → Pinhão (6,5 km · Miradouro Torguiano + comboio histórico ao Porto)
- Dia 12: Dia livre no Porto (Patrimônio UNESCO, caves de Vinho do Porto)
...
NÃO INCLUI: voos, almoços e jantares, seguro de viagem, transfers de chegada/saída em Valença e Porto.
...
REGIÃO: Vale do Douro, Portugal (UNESCO)
NÍVEL: Moderado
FORMATO: Grupo guiado — carga da mochila retirada diariamente pelo guia

DESTAQUES:
- Enoteca da Quinta da Avessada: vindima autêntica com enólogo, Moscatel de Favaios
- Favaios, a Aldeia Vinhateira do século XVIII
- Miradouro dos socalcos em terraços (vinhas UNESCO)
- Transfer de saída para o aeroporto incluído (inclui trem Pinhão → Porto)

TARIFAS (por pessoa):
€ 5.100 (tarifa padrão, base dupla)
Parcelado: 30% entrada + saldo no cartão (consulte)
À vista: € 4.800 (10% desconto)
...
REGIÃO: Vale do Douro, Portugal (UNESCO)
NÍVEL: Moderado
FORMATO: Autoguiado (sem guia acompanhante, transferência de bagagem incluída)
...
- Dia 3: Régua → Samodães, caminhada próxima a Lamego (9,4 km · Quinta da Pacheca, transfer a Alijó)
...
NÃO INCLUI: guia acompanhante, voos, almoços e jantares, seguro de viagem, transfers de chegada/saída.
