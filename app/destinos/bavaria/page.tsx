            ...
            <div className="mt-14 border-t pt-10" style={{ borderColor: "rgba(59,125,128,0.35)" }}>
              <div className="overflow-hidden rounded-2xl" style={{ border: `1px solid rgba(59,125,128,0.32)`, backgroundColor: "rgba(59,125,128,0.05)" }}>
                <div className="flex flex-wrap items-center justify-between gap-2 px-6 py-4" style={{ borderBottom: `1px solid rgba(59,125,128,0.18)` }}>
                  ...
                  <span className="text-[10px] font-medium uppercase tracking-[0.14em]" style={{ color: B.textSoft }}>Promoção válida até 30 de setembro de 2026</span>
                </div>
      ...
      <section className="px-6 py-20 md:px-10 md:py-24" style={{ background: B.lagoDeep }}>
        <div className="mx-auto max-w-[860px] text-center">
          <Reveal>
            ...
            <button type="button" onClick={() => window.dispatchEvent(new CustomEvent("open-aonikia"))} className="mt-7 inline-flex items-center gap-3 rounded-full border px-7 py-3.5 text-[12px] font-semibold uppercase tracking-[0.16em] transition-all duration-300 hover:opacity-80" style={{ borderColor: B.sage, color: B.sage }}>
