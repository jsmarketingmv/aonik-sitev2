...
/* ============================================================
   CRUZEIRO SKORPIOS — Ruta Kawéskar (PATAGÔNIA)
   Personalidade do lugar: o LABIRINTO DE CANAIS (não um anel),
   a ESCALA do gelo (não desnível), o povo KAWÉSQAR (não 3 países),
   e a paleta REAL: turquesa do degelo, fiorde, gelo, estepe ocre.
   ============================================================ */
const P = {
  abyss: "#072330", // fiorde profundo (mais escuro)
  fjord: "#0e3a49", // teal de fiorde
  ice: "#7fd4e0", // turquesa do degelo — COR-ASSINATURA
  iceDeep: "#3f93b2",
  white: "#e9f5f8", // branco-gelo
  steppe: "#cda878", // ocre da estepe — contraste quente/vida
  paper: "#e4edef", // pedra clara fria
  line: "rgba(127,212,224,0.22)",
};

// ---------- MAPA DOS CANAIS (rota sinuosa, não um anel) ----------
const STOPS = [
...
function IceScale() {
  ...
  return (
    <svg viewBox="0 0 130 250" className="w-full" style={{ maxWidth: 130 }}>
      ...
      {/* navio minúsculo na base — a escala humana */}
...
export default function CruzeiroSkorpiosPage() {
  return (
    <main className="relative" style={{ background: P.paper }}>
      <Nav />

      {/* ===== HERO — O LABIRINTO DE CANAIS ===== */}
      <section
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1500514966906-fe245eea9344?q=80&w=2400&auto=format&fit=crop')",
          }}
        />
        <div
          ...
          <div>
            ...
            >
              ...
              <span style={{ color: "rgba(233,245,248,0.85)" }}>
                <span className="text-[12px] uppercase tracking-[0.16em]" style={{ color: "rgba(233,245,248,0.5)" }}>
                  a partir de
                </span>{" "}
        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="flex items-center px-6 py-20 md:px-14">
            <div className="flex items-center gap-10">
              ...
              <Reveal delay={0.1}>
                <div>
                  <p className="text-[11px] font-semibold uppercase tracking-[0.32em]" style={{ color: P.ice }}>
                    A escala do gelo
                  </p>
                  <h2 className="mt-5 font-display text-[clamp(2rem,4.5vw,3.6rem)] font-light leading-[1.05]" style={{ color: P.white }}>
                    Até 60 metros
                    <br />
                    de parede viva
                  </h2>
                  <p className="mt-5 max-w-sm text-[15px] font-light leading-relaxed" style={{ color: "rgba(233,245,248,0.7)" }}>
      ...
      {/* ===== AS GELEIRAS (cor do gelo) ===== */}
      <section className="px-6 py-24 md:px-10 md:py-32" style={{ background: P.abyss, color: P.white }}>
        <div className="mx-auto max-w-[1280px]">
          <Reveal>
            <h2 className="max-w-2xl font-display text-[clamp(1.9rem,4vw,3.2rem)] font-light leading-[1.08]">
              As geleiras têm <span className="italic" style={{ color: P.ice }}>cor</span>
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-4 max-w-lg text-[15px] font-light leading-relaxed" style={{ color: "rgba(233,245,248,0.6)" }}>
              Quanto mais antigo e comprimido, mais azul. Cada geleira da rota
              tem o seu tom, do turquesa leitoso ao azul profundo.
            </p>
          </Reveal>
          <div className="mt-14 grid gap-px overflow-hidden rounded-xl" style={{ background: P.line }}>
            {GELEIRAS.map((g, i) => (
              <Reveal key={g.nome} delay={i * 0.05}>
                <div className="flex items-center gap-6 px-6 py-7 md:px-8" style={{ background: P.abyss }}>
                  <span className="h-12 w-12 shrink-0 rounded-full" style={{ background: g.cor }} />
                  <h3 className="font-display text-2xl font-light md:text-3xl" style={{ minWidth: 160 }}>
                    Glaciar {g.nome}
                  </h3>
                  <p className="text-[14px] font-light" style={{ color: "rgba(233,245,248,0.6)" }}>
                    {g.info}
                  </p>
                </div>
              </Reveal>
      ...
      <section className="relative w-full overflow-hidden" style={{ background: P.abyss }}>
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1500514966906-fe245eea9344?q=80&w=2000&auto=format&fit=crop')",
          }}
        />
        ...
        <div className="relative z-10 mx-auto max-w-[900px] px-6 py-28 text-center md:py-40">
          <Reveal>
            <p className="text-[11px] font-semibold uppercase tracking-[0.34em]" style={{ color: P.steppe }}>
              O povo dos canais
            </p>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-7 font-display text-[clamp(1.8rem,4vw,3.3rem)] font-light leading-[1.2]" style={{ color: P.white }}>
              Por milênios, os{" "}
      ...
      {/* ===== O NAVIO ===== */}
      <section className="px-6 py-24 md:px-10 md:py-32" style={{ background: P.paper, color: P.abyss }}>
        <div className="mx-auto grid max-w-[1280px] items-center gap-12 md:grid-cols-2 md:gap-16">
          <Reveal>
            <div className="relative h-[360px] overflow-hidden rounded-xl md:h-[460px]">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://images.unsplash.com/photo-1500514966906-fe245eea9344?q=80&w=1400&auto=format&fit=crop')",
                }}
              />
            </div>
          </Reveal>
          <Reveal delay={0.1}>
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.32em]" style={{ color: P.iceDeep }}>
                Refúgio flutuante
              </p>
              <h2 className="mt-5 font-display text-[clamp(1.8rem,3.6vw,3rem)] font-light leading-[1.1]">
                MN Skorpios III
              </h2>
              <p className="mt-6 text-[15px] font-light leading-relaxed" style={{ color: "rgba(7,35,48,0.7)" }}>
              ...
              <p className="mt-4 text-[15px] font-light leading-relaxed" style={{ color: "rgba(7,35,48,0.7)" }}>
      ...
      {/* ===== ROTEIRO ===== */}
      <section className="px-6 py-24 md:px-10 md:py-32" style={{ background: P.fjord, color: P.white }}>
        <div className="mx-auto max-w-[1100px]">
          <Reveal>
            <p className="text-[11px] font-semibold uppercase tracking-[0.32em]" style={{ color: P.steppe }}>
              O roteiro em essência
            </p>
          </Reveal>
          <p className="mt-4 max-w-lg text-[14px] font-light leading-relaxed" style={{ color: "rgba(233,245,248,0.55)" }}>
          ...
          <div className="mt-12">
            {ROTEIRO.map((r, i) => (
              <Reveal key={r.d} delay={i * 0.05}>
                <div className="flex items-baseline gap-6 border-t py-6 md:gap-10" style={{ borderColor: P.line }}>
                  <span className="font-display text-sm" style={{ color: P.ice }}>
                    {r.d}
                  </span>
                  <div>
                    <h3 className="font-display text-xl font-light md:text-2xl">{r.t}</h3>
                    <p className="mt-1 text-[14px] font-light" style={{ color: "rgba(233,245,248,0.55)" }}>
                      {r.s}
                    </p>
                  </div>
                </div>
      ...
      {/* ===== AONIKIA ===== */}
      <section className="px-6 py-20 md:px-10 md:py-24" style={{ background: P.abyss }}>
        <div className="mx-auto max-w-[860px] text-center">
          <Reveal>
            <p className="text-[11px] font-semibold uppercase tracking-[0.3em]" style={{ color: P.ice }}>
              AonikIA · especialista neste cruzeiro
            </p>
            <h2 className="mt-5 font-display text-[clamp(1.8rem,3.5vw,2.8rem)] font-light leading-[1.15]" style={{ color: P.white }}>
              Pergunte tudo sobre a Ruta Kawéskar
            </h2>
            <p className="mx-auto mt-4 max-w-md text-[15px] font-light leading-relaxed" style={{ color: "rgba(233,245,248,0.65)" }}>
              Cabines, melhor época, como chegar a Puerto Natales, o que está
              incluído. A AonikIA conhece este cruzeiro e já te conecta com um
              especialista.
            </p>
            <a
              href="#contato"
