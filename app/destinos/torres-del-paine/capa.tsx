...
/* ---------- dados da capa ---------- */
const PROGRAMAS = [
  { key: "journey" as const, slug: "w-journey", selo: "Novo · Guiado", nome: "W Journey Circuit", dn: "5 dias · 4 noites", estilo: "Guiado", dist: "69,5 km", preco: "US$ 3.200", destaque: "Host bilíngue do início ao fim e traslado privativo. Confirmação imediata de vagas.", img: PHOTO.prodPlus },
...
const TABELA_ROWS: { label: string; vals: string[] }[] = [
  ...
  { label: "A partir de", vals: ["US$ 3.200", "US$ 1.657", "US$ 2.126", "US$ 1.874"] },
];
