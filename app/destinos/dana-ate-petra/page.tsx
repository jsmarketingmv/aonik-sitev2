    ...
    <main className="relative" style={{ background: D.creme }}>
      ...
      <section id="reservar" className="px-6 py-24 md:px-10 md:py-32" style={{ background: D.petraDeep }}>
        <div className="mx-auto max-w-[1280px]">
          ...
          <Reveal delay={0.15}>
            <div className="mt-14 border-t pt-10" style={{ borderColor: "rgba(193,68,14,0.3)" }}>
              ...
              <div className="mt-6 flex justify-center sm:justify-end">
                <a href="#contato" className="inline-flex items-center gap-3 rounded-full px-8 py-4 text-[13px] font-semibold uppercase tracking-[0.16em] transition-transform duration-300 hover:scale-[1.03]" style={{ background: D.petra, color: D.creme }}>
                  Falar com a equipe &#8594;
                </a>
              </div>
            </div>
      ...
      <section className="px-6 py-20 md:px-10 md:py-24" style={{ background: D.petraDeep }}>
        <div className="mx-auto max-w-[860px] text-center">
          <Reveal>
            ...
            <button type="button" onClick={() => window.dispatchEvent(new CustomEvent("open-aonikia"))} className="mt-7 inline-flex items-center gap-3 rounded-full border px-7 py-3.5 text-[12px] font-semibold uppercase tracking-[0.16em] transition-all duration-300 hover:opacity-80" style={{ borderColor: D.areia, color: D.areia }}>
